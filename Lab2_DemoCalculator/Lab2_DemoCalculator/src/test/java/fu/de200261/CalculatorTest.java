...
public class CalculatorTest {
    ...
    @CsvFileSource(resources = "/data.csv", numLinesToSkip = 1) @DisplayName("multiply: kiểm thử với nhiều bộ dữ liệu từ CSV") void multiply_VariousInputs_ReturnsProduct(int a, int b, int expected) {     // Arrange: a, b, expected do JUnit inject từ CSV
